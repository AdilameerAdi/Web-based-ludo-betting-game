          ...
          <div className="relative flex flex-col min-h-0">
            ...
            <div className="mt-6 pt-6 border-t border-yellow-500/20 text-center flex-shrink-0">
              ...
              <button
                ...
                className="group relative px-6 py-2.5 bg-gradient-to-r from-red-600 to-red-700 text-white font-bold text-sm sm:text-base rounded-xl shadow-lg hover:shadow-red-500/50 transform hover:scale-105 active:scale-95 transition-all duration-300 overflow-hidden"
              >
