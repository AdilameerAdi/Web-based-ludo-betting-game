    ...
    <div className={`fixed left-0 top-0 h-full bg-white border-r border-gray-200 transition-all duration-300 z-30 ${
      ...
      <div className="border-t border-gray-200 p-4">
        <button
          ...
          className={`w-full flex items-center px-4 py-3 text-left text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors rounded-lg ${
            sidebarCollapsed ? 'justify-center' : ''
          }`}
        >
          <span className="text-xl text-red-500 mr-3 flex-shrink-0">🚪</span>
          {!sidebarCollapsed && (
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-gray-900">Commission Received from Games</h2>
          <p className="text-sm text-gray-500 mt-1">View all commission records from completed games</p>
        </div>
...
function AddFundsHistory({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-gray-900">Add Funds History</h2>
          <p className="text-sm text-gray-500 mt-1">View all successful add funds transactions</p>
        </div>
                    ...
                    <tbody>
                      {users.map((user) => (
                        <tr key={user.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                          <td className="py-3 px-4 font-medium text-gray-900">{user.mobile}</td>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">View all completed game matches</p>
        </div>
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Winner Payout</th>
